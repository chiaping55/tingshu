...
| 哔哩哔哩 | bilibili.com | B 站音頻區:多人有聲劇、同人音声,片源和其它源都不同。**不參與聚合搜尋**,想找 B 站內容請點進這個源裡瀏覽;播放頁要多等幾秒(音頻經內置瀏覽器加載),手錶等裝置不能用 |
...
除爱听书、哔哩哔哩外,所有書源的音頻都是 mp3/m4a 直鏈,不需要 WebView,手錶等裝置也能用。
